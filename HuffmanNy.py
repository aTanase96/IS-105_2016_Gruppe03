...
class HuffmanNode(object):
    ...
    #Creating the objects and definind the path which they will take and what they will do if they do not encounter anything that fits with the code
freq = [
    ...
    (1.974, 'y'), (0.074, 'z') ]
#The frequencies of all the letters with a total of a hundred in value (which is 100%)
